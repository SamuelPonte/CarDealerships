                        ...
                        <div class="col-lg-9 pt-3 pe-5">
                            ...
                            <div style="margin-top: 150px;">
                                ...
                                <div class="RightLeft">
                                    ...
                                    <form class="m-1 form-inline float-right" method="POST" action="<?php echo route('UserAdvertsDelete/' . $car->id); ?>">
                                        <input type="hidden" name="car_id" value="<?php echo $car->id ?>">
                                        <button type="submit" class="btn btn-danger">Delete</button>
                                    </form>
                                    <form class="m-1 form-inline float-right" method="POST" action="<?php echo route('UserAdvertsUpdate/' . $car->id); ?>">
